...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    'child.pairing.regenerate': 'Generate Ulang',
    'child.pairing.copy': 'Salin Kode',
    'child.pairing.copied': 'Tersalin!',
    'child.pairing.codeLabel': 'Kode Pairing Anda',
    'child.pairing.codeHint': 'Minta lansia memasukkan kode ini di device mereka',
    'child.pairing.paired': 'Terhubung',
    'child.pairing.notPaired': 'Belum Terhubung',
    'child.pairing.disconnect': 'Putuskan Koneksi',
    'child.pairing.disconnectConfirm': 'Yakin ingin memutuskan koneksi?',
    ...
    'elderly.pairing.error': 'Kode tidak valid. Silakan coba lagi.',
    'elderly.pairing.disconnect': 'Putuskan Koneksi',
  },
  en: {
    // Sidebar
    'sidebar.logo': 'SAPA',
    ...
    // Child Pairing
    'child.sidebar.pairDevice': 'Pair Device',
    'child.pairing.title': 'Connect with Elderly Device',
    'child.pairing.subtitle': 'Generate a unique code to connect with the elderly device',
    'child.pairing.generate': 'Generate Code',
    'child.pairing.regenerate': 'Regenerate Code',
    'child.pairing.copy': 'Copy Code',
    'child.pairing.copied': 'Copied!',
    'child.pairing.codeLabel': 'Your Pairing Code',
    'child.pairing.codeHint': 'Ask the elderly person to enter this code on their device',
    'child.pairing.paired': 'Connected',
    'child.pairing.notPaired': 'Not Connected',
    'child.pairing.disconnect': 'Disconnect',
    'child.pairing.disconnectConfirm': 'Are you sure you want to disconnect?',
    'elderly.pairing.title': 'Connect with Child Device',
    'elderly.pairing.inputPlaceholder': 'Enter 6-character code',
    'elderly.pairing.connect': 'Connect',
    'elderly.pairing.paired': 'Connected with',
    'elderly.pairing.success': 'Successfully connected!',
    'elderly.pairing.error': 'Invalid code. Please try again.',
    'elderly.pairing.disconnect': 'Disconnect',
  },
};
