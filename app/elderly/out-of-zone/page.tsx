  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-bold text-red-700">Out of Safe Zone</h1>
          <p className="text-sm text-red-600">You have moved outside the designated safe area</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-red-50 rounded-lg p-3">
              ...
              <p className="text-lg font-bold text-red-600">{distanceFromZone} meters</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-blue-50 rounded-lg p-3">
              <p className="text-xs text-gray-500 mb-1">Safe Radius</p>
              <p className="text-sm font-bold text-blue-600">{SAFE_ZONE_RADIUS} meters</p>
            </div>
            <div className="bg-red-50 rounded-lg p-3">
              <p className="text-xs text-gray-500 mb-1">Status</p>
              <p className="text-sm font-bold text-red-600">OUT OF SAFE ZONE</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-red-200 p-4">
          ...
          <div className="flex flex-col items-center justify-center py-4">
            <p className="text-xs text-red-500 mb-4 text-center font-medium">Tap for immediate assistance</p>
