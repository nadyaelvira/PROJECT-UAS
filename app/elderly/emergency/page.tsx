      ...
      <div className="bg-red-600 py-10 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="flex items-center justify-center gap-4">
            ...
            <h1 className="text-5xl font-bold text-white">{t('emergency.help')}</h1>
            <span className="text-5xl">⚠️</span>
          </div>
          <p className="text-xl text-red-100 mt-3">{t('emergency.subtitle')}</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
          ...
          <div className="bg-gray-50 p-8 flex flex-col items-center border-b border-gray-100">
            ...
            <p className="text-sm text-gray-500">{t('emergency.photo')}</p>
          </div>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">69 {t('emergency.years')}</p>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 rounded-lg p-4 flex items-center gap-4 border border-yellow-200">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-yellow-700">{t('emergency.dementia')}</p>
              </div>
            </div>
          </div>
        </div>
