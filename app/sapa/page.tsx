...
export default function SapaLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Apa itu SAPA Section */}
      <section id="apa-itu-sapa" className="py-20" style={{ background: 'linear-gradient(to bottom, #dbeafe, #ffffff)' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      {/* Features Section */}
      <section id="features" className="py-20" style={{ background: '#1e3a8a' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section id="how-it-works" className="py-20" style={{ background: '#f3f4f6' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
